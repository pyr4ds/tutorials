...
library(learnr)
knitr::opts_chunk$set(echo = TRUE, results = TRUE, exercise.lines = 3)
```
...
The simplest of these objects is the `vector object` which are six in number. The other R-Objects are built upon the atomic vectors.   
